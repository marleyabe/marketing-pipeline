...
DAG_ID = "daily_extract_google_ads_demographics"
...
def daily_extract_google_ads_demographics():
    ...
    def extract_account(account: dict) -> list[dict]:
        ...
        return extractor.extract_demographics([account["customer_id"]], ds)
    ...
    def load(batches: list[list[dict]]) -> None:
        ...
        for batch in batches:
            loader.load(batch, "google_ads_demographics_raw", source="google_ads")
...
dag = daily_extract_google_ads_demographics()
